...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const translations = {
    ...
    hi: {
      ...
      'heart-age': 'आयु', // Added Hindi
      'heart-gender': 'लिंग', // Added Hindi
      'heart-bp': 'रक्त चाप (mmHg)', // Added Hindi
      'heart-cholesterol': 'कोलेस्ट्रॉल (mg/dL)', // Added Hindi
      'heart-sugar': 'उपवास रक्त शर्करा (mg/dL)', // Added Hindi
      'heart-exercise': 'नियमित व्यायाम?', // Added Hindi
      ...
      'diabetes-age': 'आयु', // Added Hindi
      'diabetes-glucose': 'ग्लूकोज स्तर (mg/dL)', // Added Hindi
      'diabetes-bmi': 'बीएमआई', // Added Hindi
      'diabetes-insulin': 'इंसुलिन स्तर (mu U/ml)', // Added Hindi
      'diabetes-skin': 'त्वचा की मोटाई (mm)', // Added Hindi
      'diabetes-family': 'मधुमेह का पारिवारिक इतिहास?', // Added Hindi
      ...
      'parkinsons-age': 'आयु', // Added Hindi
      'parkinsons-gender': 'लिंग', // Added Hindi
      'parkinsons-tremor': 'क्या आपको आराम करते समय कंपन महसूस होता है?', // Added Hindi
      'parkinsons-rigidity': 'क्या आपको मांसपेशियों में अकड़न या कठोरता महसूस होती है?', // Added Hindi
      'parkinsons-balance': 'क्या आपको संतुलन या चलने में कठिनाई होती है?', // Added Hindi
      'parkinsons-speech': 'क्या आपने अपनी वाणी में कोई बदलाव देखा है?', // Added Hindi
    ...
    // Marathi translations (Placeholder - NEEDS ACTUAL TRANSLATION)
    mr: {
      // ... (Copy all keys from 'en' and replace values with Marathi translations) ...
      'nav-home': '[mr] Home',
      'nav-services': '[mr] Services',
      'nav-diagnostic': '[mr] Diagnostic Tools',
      'nav-contact': '[mr] Contact',
      'hero-title': '[mr] Advanced Healthcare at Your Fingertips',
      'hero-description': '[mr] Access cutting-edge diagnostic tools, professional healthcare advice, and emergency assistance all in one place.',
      'hero-cta-primary': '[mr] Try Our Diagnostic Tools',
      'hero-cta-secondary': '[mr] Explore Services',
      'services-title': '[mr] Our Services',
      'services-description': '[mr] Comprehensive healthcare solutions designed for your well-being',
      'service-heart-title': '[mr] Heart Health Assessment',
      'service-heart-description': '[mr] Early detection of heart disease risk factors through comprehensive analysis',
      'service-diabetes-title': '[mr] Diabetes Screening',
      'service-diabetes-description': '[mr] Advanced diabetes risk assessment and management guidelines',
      'service-parkinsons-title': '[mr] Parkinson\'s Analysis',
      'service-parkinsons-description': '[mr] Early signs detection through specialized symptom evaluation',
      'service-skin-title': '[mr] Skin Condition Analysis',
      'service-skin-description': '[mr] AI-powered skin condition assessment through image analysis',
      'service-mri-title': '[mr] Brain MRI Evaluation',
      'service-mri-description': '[mr] Advanced brain tumor detection through MRI scan analysis',
      'service-chatbot-title': '[mr] AI Health Assistant',
      'service-chatbot-description': '[mr] Get immediate answers to your health questions from our AI chatbot',
      'chatbot-btn': '[mr] Chat Now',
      'diagnostic-title': '[mr] Diagnostic Tools',
      'diagnostic-description': '[mr] Advanced health assessment tools to monitor your well-being',
      'tab-heart': '[mr] Heart Health',
      'tab-diabetes': '[mr] Diabetes',
      'tab-parkinsons': '[mr] Parkinson\'s',
      'tab-skin': '[mr] Skin Analysis',
      'tab-brain': '[mr] Brain MRI',
      'heart-form-title': '[mr] Heart Disease Risk Assessment',
      'heart-form-description': '[mr] Fill in the details below for a preliminary heart health assessment',
      'heart-age': '[mr] Age',
      'heart-gender': '[mr] Gender',
      'heart-bp': '[mr] Blood Pressure (mmHg)',
      'heart-cholesterol': '[mr] Cholesterol (mg/dL)',
      'heart-sugar': '[mr] Fasting Blood Sugar (mg/dL)',
      'heart-exercise': '[mr] Regular Exercise?',
      'diabetes-form-title': '[mr] Diabetes Risk Assessment',
      'diabetes-form-description': '[mr] Fill in the details below for a preliminary diabetes risk assessment',
      'diabetes-age': '[mr] Age',
      'diabetes-glucose': '[mr] Glucose Level (mg/dL)',
      'diabetes-bmi': '[mr] BMI',
      'diabetes-insulin': '[mr] Insulin Level (mu U/ml)',
      'diabetes-skin': '[mr] Skin Thickness (mm)',
      'diabetes-family': '[mr] Family History of Diabetes?',
      'parkinsons-form-title': '[mr] Parkinson\'s Disease Assessment',
      'parkinsons-form-description': '[mr] Fill in the details below for a preliminary Parkinson\'s disease assessment',
      'parkinsons-age': '[mr] Age',
      'parkinsons-gender': '[mr] Gender',
      'parkinsons-tremor': '[mr] Do you experience tremors at rest?',
      'parkinsons-rigidity': '[mr] Do you experience muscle stiffness or rigidity?',
      'parkinsons-balance': '[mr] Do you have difficulty with balance or walking?',
      'parkinsons-speech': '[mr] Have you noticed changes in your speech?',
      'skin-form-title': '[mr] Skin Condition Analysis',
      'skin-form-description': '[mr] Upload a clear image of the affected skin area for analysis',
      'skin-upload': '[mr] Drag & Drop or Click to Upload Image',
      'skin-upload-note': '[mr] JPG, PNG or JPEG (Max 5MB)',
      'skin-duration': '[mr] How long have you had this condition?',
      'skin-symptoms': '[mr] Any additional symptoms?',
      'brain-form-title': '[mr] Brain Tumor Detection',
      'brain-form-description': '[mr] Upload an MRI scan image for brain tumor detection analysis',
      'mri-upload': '[mr] Drag & Drop or Click to Upload MRI Scan',
      'mri-upload-note': '[mr] JPG, PNG or JPEG (Max 10MB)',
      'mri-date': '[mr] Date of MRI Scan',
      'mri-symptoms': '[mr] Symptoms Experienced',
      'select-option': '[mr] Select an option',
      'gender-male': '[mr] Male',
      'gender-female': '[mr] Female',
      'gender-other': '[mr] Other',
      'option-yes': '[mr] Yes',
      'option-no': '[mr] No',
      'btn-analyze': '[mr] Analyze',
      'duration-days': '[mr] Days',
      'duration-weeks': '[mr] Weeks',
      'duration-months': '[mr] Months',
      'duration-years': '[mr] Years',
      'chatbot-label': '[mr] Chat with Health Assistant',
      'contact-title': '[mr] Contact Us',
      'contact-description': '[mr] Reach out to our healthcare professionals for assistance',
      'contact-address-title': '[mr] Address',
      'contact-address': '[mr] 123 Healthcare Avenue, Medical District, New Delhi, 110001',
      'contact-phone-title': '[mr] Phone',
      'contact-email-title': '[mr] Email',
      'emergency-title': '[mr] Emergency Contact',
      'emergency-ambulance': '[mr] Ambulance Service',
      'emergency-helpline': '[mr] National Health Helpline',
      'contact-form-title': '[mr] Send Us a Message',
      'contact-name': '[mr] Name',
      'contact-email': '[mr] Email',
      'contact-phone': '[mr] Phone',
      'contact-subject': '[mr] Subject',
      'contact-message': '[mr] Message',
      'btn-send': '[mr] Send Message',
      'footer-about-title': '[mr] About MediCare+',
      'footer-about-description': '[mr] MediCare+ is a leading healthcare platform providing advanced diagnostic tools and medical services to ensure your well-being.',
      'footer-links-title': '[mr] Quick Links',
      'footer-link-home': '[mr] Home',
      'footer-link-services': '[mr] Services',
      'footer-link-diagnostic': '[mr] Diagnostic Tools',
      'footer-link-contact': '[mr] Contact',
      'footer-link-privacy': '[mr] Privacy Policy',
      'footer-link-terms': '[mr] Terms of Service',
      'footer-services-title': '[mr] Our Services',
      'footer-service-heart': '[mr] Heart Health',
      'footer-service-diabetes': '[mr] Diabetes',
      'footer-service-parkinsons': '[mr] Parkinson\'s',
      'footer-service-skin': '[mr] Skin Analysis',
      'footer-service-brain': '[mr] Brain MRI',
      'footer-service-chatbot': '[mr] AI Health Assistant',
      'footer-newsletter-title': '[mr] Newsletter',
      'footer-newsletter-description': '[mr] Subscribe to our newsletter for the latest health updates and tips.',
      'footer-copyright': '[mr] © 2025 MediCare+. All Rights Reserved.',
      'footer-disclaimer': '[mr] Disclaimer: This website is for informational purposes only and is not a substitute for professional medical advice.'
    },
    ...
    bn: {
      ...
      'heart-age': 'বয়স',
      'heart-gender': 'লিঙ্গ',
      'heart-bp': 'রক্তচাপ (mmHg)',
      'heart-cholesterol': 'কোলেস্টেরল (mg/dL)',
      'heart-sugar': 'অভুক্ত রক্তে শর্করা (mg/dL)',
      'heart-exercise': 'নিয়মিত ব্যায়াম করেন?',
      ...
      'diabetes-age': 'বয়স',
      'diabetes-glucose': 'গ্লুকোজ স্তর (mg/dL)',
      'diabetes-bmi': 'বিএমআই',
      'diabetes-insulin': 'ইনসুলিন স্তর (mu U/ml)',
      'diabetes-skin': 'চর্মের পুরুত্ব (mm)',
      'diabetes-family': 'ডায়াবেটিস পারিবারিক ইতিহাস আছে?',
      ...
      'parkinsons-age': 'বয়স',
      'parkinsons-gender': 'লিঙ্গ',
      'parkinsons-tremor': 'বিশ্রামের সময় কম্পন অনুভব করেন?',
      'parkinsons-rigidity': 'পেশীতে জড়তা বা শক্ততা অনুভব করেন?',
      'parkinsons-balance': 'ভারসাম্য বা হাঁটার ক্ষেত্রে সমস্যা হয়?',
      'parkinsons-speech': 'আপনার কথায় কোনো পরিবর্তন লক্ষ্য করেছেন?',
    ...
    or: {
      ...
      'heart-age': 'ବୟସ',
      'heart-gender': 'ଲିଙ୍ଗ',
      'heart-bp': 'ରକ୍ତଚାପ (mmHg)',
      'heart-cholesterol': 'କୋଲେଷ୍ଟେରଲ୍ (mg/dL)',
      'heart-sugar': 'ଅପାହାର ରକ୍ତ ଚିନି (mg/dL)',
      'heart-exercise': 'ନିୟମିତ ବ୍ୟାୟାମ କରନ୍ତି କି?',
      ...
      'diabetes-age': 'ବୟସ',
      'diabetes-glucose': 'ଗ୍ଲୁକୋଜ୍ ସ୍ତର (mg/dL)',
      'diabetes-bmi': 'BMI',
      'diabetes-insulin': 'ଇନସୁଲିନ୍ ସ୍ତର (mu U/ml)',
      'diabetes-skin': 'ଚର୍ମ ମୋଟାଉଟି (mm)',
      'diabetes-family': 'ଡାୟାବେଟିସ୍ ପରିବାରରେ ରହିଛି କି?',
      ...
      'parkinsons-age': 'ବୟସ',
      'parkinsons-gender': 'ଲିଙ୍ଗ',
      'parkinsons-tremor': 'ବିଶ୍ରାମ ସମୟରେ କମ୍ପନ ଅନୁଭବ କରନ୍ତି କି?',
      'parkinsons-rigidity': 'ମାଂସପେଶୀରେ ଜଡତା ଅନୁଭବ କରନ୍ତି କି?',
      'parkinsons-balance': 'ସମତୁଳନ କିମ୍ବା ଚାଲିବାରେ ସମସ୍ୟା ଅଛି କି?',
      'parkinsons-speech': 'କଥାରେ କୌଣସି ପରିବର୍ତ୍ତନ ଅନୁଭବ କରିଛନ୍ତି କି?',
    ...
    ta: {
      ...
      'heart-age': 'வயது',
      'heart-gender': 'பாலினம்',
      'heart-bp': 'இரத்த அழுத்தம் (mmHg)',
      'heart-cholesterol': 'கொலஸ்ட்ரால் (mg/dL)',
      'heart-sugar': 'பாஸ்டிங் சர்க்கரை (mg/dL)',
      'heart-exercise': 'நீங்கள் வழக்கமாக உடற்பயிற்சி செய்கிறீர்களா?',
      ...
      'diabetes-age': 'வயது',
      'diabetes-glucose': 'குளுக்கோஸ் நிலை (mg/dL)',
      'diabetes-bmi': 'BMI',
      'diabetes-insulin': 'இன்சுலின் நிலை (mu U/ml)',
      'diabetes-skin': 'தோலின் தடிமன் (mm)',
      'diabetes-family': 'உங்கள் குடும்பத்தில் நீரிழிவுடன் யாராவது உள்ளதா?',
      ...
      'parkinsons-age': 'வயது',
      'parkinsons-gender': 'பாலினம்',
      'parkinsons-tremor': 'ஓய்வின் போது நடுக்கம் இருக்கிறதா?',
      'parkinsons-rigidity': 'தசைகளில் இறுக்கம் இருக்கிறதா?',
      'parkinsons-balance': 'நடக்கையில் சிக்கல் இருக்கிறதா?',
      'parkinsons-speech': 'உங்கள் பேச்சில் ஏதாவது மாற்றம் உள்ளதா?',
    ...
    te: {
      ...
      'heart-gender': 'లింగం',
      'heart-bp': 'బీపీ (mmHg)',
      'heart-cholesterol': 'కొలెస్ట్రాల్ (mg/dL)',
      'heart-sugar': 'ఉపవాస గ్లూకోజ్ (mg/dL)',
      'heart-exercise': 'మీరు నియమిత వ్యాయామం చేస్తారా?',
      'diabetes-form-title': 'డయాబెటిస్ ప్రమాదం',
      'diabetes-form-description': 'ప్రమాదాన్ని అంచనా వేయడానికి ఈ వివరాలను నమోదు చేయండి',
      'diabetes-age': 'వయస్సు',
      'diabetes-glucose': 'గ్లూకోజ్ స్థాయి (mg/dL)',
      'diabetes-bmi': 'BMI',
      'diabetes-insulin': 'ఇన్సులిన్ స్థాయి (mu U/ml)',
      'diabetes-skin': 'చర్మ మేమ్ చుట్టు మందం (mm)',
      'diabetes-family': 'మీ కుటుంబంలో డయాబెటిస్ ఉన్నవారు ఉన్నారా?',
      'parkinsons-form-title': 'పార్కిన్సన్స్ మూల్యాంకనం',
      'parkinsons-form-description': 'ఈ వివరాలను ఉపయోగించి ముందస్తు అంచనా',
      'parkinsons-age': 'వయస్సు',
      'parkinsons-gender': 'లింగం',
      'parkinsons-tremor': 'ఆరామ సమయంలో కంపనం ఉందా?',
      'parkinsons-rigidity': 'కండరాల గట్టితనం ఉందా?',
      'parkinsons-balance': 'నడకలో అసమతుల్యత ఉందా?',
      'parkinsons-speech': 'మీ మాటలో ఏమైనా మార్పు ఉందా?',
    ...
    // Santhali translations (Placeholder - NEEDS ACTUAL TRANSLATION) - ISO code 'sat'
    sat: {
       // ... (Copy all keys from 'en' and replace values with Santhali translations) ...
      'nav-home': '[sat] Home',
      'nav-services': '[sat] Services',
       // ... etc ... fill all keys like Marathi example above
      'footer-copyright': '[sat] © 2025 MediCare+. All Rights Reserved.',
      'footer-disclaimer': '[sat] Disclaimer: This website is for informational purposes only and is not a substitute for professional medical advice.'
    },
    ...
    kn: {
      ...
      'heart-age': 'ವಯಸ್ಸು',
      'heart-gender': 'ಲಿಂಗ',
      'heart-bp': 'ರಕ್ತದೊತ್ತಡ (mmHg)',
      'heart-cholesterol': 'ಕೋಲೆಸ್ಟ್ರಾಲ್ (mg/dL)',
      'heart-sugar': 'ಊಟದ ಮೊದಲು ಶರ್ಕರೆ ಮಟ್ಟ (mg/dL)',
      'heart-exercise': 'ನಿಯಮಿತವಾಗಿ ವ್ಯಾಯಾಮ ಮಾಡುತ್ತೀರಾ?',
      ...
      'diabetes-age': 'ವಯಸ್ಸು',
      'diabetes-glucose': 'ಗ್ಲುಕೋಸ್ ಮಟ್ಟ (mg/dL)',
      'diabetes-bmi': 'BMI',
      'diabetes-insulin': 'ಇನ್ಸುಲಿನ್ ಮಟ್ಟ (mu U/ml)',
      'diabetes-skin': 'ಚರ್ಮದ ದಪ್ಪ (mm)',
      ...
      'parkinsons-age': 'ವಯಸ್ಸು',
      'parkinsons-gender': 'ಲಿಂಗ',
      'parkinsons-tremor': 'ನಿಶ್ಚಲ ಸ್ಥಿತಿಯಲ್ಲಿ ಕಂಪನವಿದೆವೆಯಾ?',
      'parkinsons-rigidity': 'ಪೇಶಿಗಳಿಗೆ ಗಟ್ಟಿತನವಿದೆವೆಯಾ?',
      'parkinsons-balance': 'ಸಂತುಲನ ಅಥವಾ ನಡೆಯುವಲ್ಲಿ ತೊಂದರೆ ಇತ್ತೆ?',
      'parkinsons-speech': 'ನಿಮ್ಮ ಮಾತಿನಲ್ಲಿ ಏನಾದರೂ ಬದಲಾವಣೆ ಕಾಣಿಸಿದ್ದೀರಾ?',
    ...
    pa: {
      ...
      "heart-age": "ਉਮਰ",
      "heart-gender": "ਲਿੰਗ",
      "heart-bp": "ਰਕਤ ਚਾਪ (mmHg)",
      "heart-cholesterol": "ਕੋਲੈਸਟ੍ਰੋਲ (mg/dL)",
      "heart-sugar": "ਖਾਲੀ ਪੇਟ ਰਕਤ ਵਿੱਚ ਸ਼ੂਗਰ (mg/dL)",
      "heart-exercise": "ਕੀ ਤੁਸੀਂ ਨਿਯਮਤ ਵਿਆਯਾਮ ਕਰਦੇ ਹੋ?",
      "diabetes-form-title": "ਸ਼ੂਗਰ ਜੋਖਮ ਮੁਲਾਂਕਣ",
      "diabetes-form-description": "ਪ੍ਰਾਰੰਭਿਕ ਸ਼ੂਗਰ ਮੁਲਾਂਕਣ ਲਈ ਹੇਠਾਂ ਦਿੱਤੇ ਗਏ ਵੇਰਵੇ ਭਰੋ",
      "diabetes-age": "ਉਮਰ",
      "diabetes-glucose": "ਗਲੂਕੋਜ਼ ਸਤਰ (mg/dL)",
      "diabetes-bmi": "ਬੀ.ਐਮ.ਆਈ.",
      "diabetes-insulin": "ਇੰਸੁਲਿਨ ਸਤਰ (mu U/ml)",
      "diabetes-skin": "ਚਮੜੀ ਦੀ ਮੋਟਾਈ (mm)",
      "diabetes-family": "ਕੀ ਤੁਹਾਡੇ ਪਰਿਵਾਰ ਵਿੱਚ ਸ਼ੂਗਰ ਦਾ ਇਤਿਹਾਸ ਹੈ?",
      "parkinsons-form-title": "ਪਾਰਕੀਨਸਨ ਮੁਲਾਂਕਣ",
      "parkinsons-form-description": "ਪ੍ਰਾਰੰਭਿਕ ਪਾਰਕੀਨਸਨ ਮੁਲਾਂਕਣ ਲਈ ਹੇਠਾਂ ਦਿੱਤੇ ਗਏ ਵੇਰਵੇ ਭਰੋ",
      "parkinsons-age": "ਉਮਰ",
      "parkinsons-gender": "ਲਿੰਗ",
      "parkinsons-tremor": "ਕੀ ਤੁਹਾਨੂੰ ਅਰਾਮ ਕਰਨ ਸਮੇਂ ਕੰਪਨ ਮਹਿਸੂਸ ਹੁੰਦਾ ਹੈ?",
      "parkinsons-rigidity": "ਕੀ ਤੁਸੀਂ ਪੇਸ਼ੀ ਵਿੱਚ ਠੋਸਤਾ ਮਹਿਸੂਸ ਕਰਦੇ ਹੋ?",
      "parkinsons-balance": "ਕੀ ਤੁਹਾਨੂੰ ਤਵਾਜੋ ਜਾਂ ਚੱਲਣ ਵਿੱਚ ਮੁਸ਼ਕਲ ਆਉਂਦੀ ਹੈ?",
      "parkinsons-speech": "ਕੀ ਤੁਹਾਡੇ ਬੋਲਣ ਵਿੱਚ ਕੋਈ ਬਦਲਾਅ ਆਇਆ ਹੈ?",
    ...
    // Malayalam translations (Placeholder - NEEDS ACTUAL TRANSLATION)
    ml: {
       // ... (Copy all keys from 'en' and replace values with Malayalam translations) ...
      'nav-home': '[ml] Home',
      'nav-services': '[ml] Services',
       // ... etc ... fill all keys like Marathi example above
      'footer-copyright': '[ml] © 2025 MediCare+. All Rights Reserved.',
      'footer-disclaimer': '[ml] Disclaimer: This website is for informational purposes only and is not a substitute for professional medical advice.'
    },
    ...
    ur:{
      ...
      'diabetes-age': 'عمر',
      'diabetes-glucose': 'گلوکوز کی سطح (mg/dL)',
      'diabetes-bmi': 'بی ایم آئی',
      'diabetes-insulin': 'انسولین کی سطح (mu U/ml)',
      'diabetes-skin': 'جلد کی موٹائی (mm)',
      'diabetes-family': 'کیا ذیابیطس کا خاندانی تاریخ ہے؟',
      ...
      'parkinsons-age': 'عمر',
      'parkinsons-gender': 'جنس',
      'parkinsons-tremor': 'کیا آپ آرام کے دوران کپکپاہٹ محسوس کرتے ہیں؟',
      'parkinsons-rigidity': 'کیا آپ پٹھوں میں جمود یا سختی محسوس کرتے ہیں؟',
      'parkinsons-balance': 'کیا آپ کو توازن یا چلنے میں دشواری ہوتی ہے؟',
      'parkinsons-speech': 'کیا آپ نے اپنی تقریر میں کوئی تبدیلی محسوس کی ہے؟',
